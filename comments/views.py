...
def comment(request, post_pk):
    ...
    if form.is_valid():
        ...
        messages.add_message(request, messages.SUCCESS, 'Comment success！', extra_tags='success')
    ...
    messages.add_message(request, messages.ERROR, 'Failed to comment', extra_tags='danger')
